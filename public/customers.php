...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        log_activity('update','Customers','Customer updated: '.($d['name']??''),'ID:'.$id);
        ...
        log_activity('create','Customers','Customer added: '.($d['name']??''),'Phone:'.($d['phone']??''));
...
if (isset($_GET['delete'])) {
    ...
    log_activity('delete','Customers','Customer deleted','ID:'.$did);
