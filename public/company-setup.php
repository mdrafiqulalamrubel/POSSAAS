...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($err)) {
        ...
        log_activity('update','Settings','Company settings updated',$fields['company_name']??'');
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="form-grid">
      <div class="form-group">
        ...
        <input type="text" name="currency" value="<?= h($cs['currency'] ?? '$') ?>" placeholder="$" maxlength="5">
      </div>
      <div class="form-group">
        <label>Currency Code</label>
        <input type="text" name="currency_code" value="<?= h($cs['currency_code'] ?? 'USD') ?>" placeholder="USD" maxlength="5">
      </div>
      <div class="form-group">
